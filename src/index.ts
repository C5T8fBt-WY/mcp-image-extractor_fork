...
const server = new McpServer({
  ...
  description: "MCP server for analyzing images and PDF documents from files and URLs for visual content understanding, text extraction (OCR), and object recognition in screenshots, photos, and PDF pages",
